...
public class ProductProfileRepository
{
    ...
    public IReadOnlyList<ProductProfile> GetByAccount(string accountKey)
    {
        ...
        {
            ReloadNoLock();
            return _products.Where(p => string.Equals(p.AccountKey, accountKey, StringComparison.OrdinalIgnoreCase))
                .ToList()
                .AsReadOnly();
        }
    }
...
public class ProductCampaignMappingRepository
{
    ...
    public IReadOnlyList<ProductCampaignMapping> GetByAccount(string accountKey)
    {
        ...
        {
            ReloadNoLock();
            return _mappings.Where(m => string.Equals(m.AccountKey, accountKey, StringComparison.OrdinalIgnoreCase))
                .ToList()
                .AsReadOnly();
        }
    }
    ...
    public ProductCampaignMapping? GetById(string id)
    {
        ...
        {
            ReloadNoLock();
            return _mappings.FirstOrDefault(m => m.Id == id);
        }
    }
    ...
    public List<ProductCampaignMapping> GetAll()
    {
        lock (_sync)
        {
            ReloadNoLock();
